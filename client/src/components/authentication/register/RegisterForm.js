...
export default function RegisterForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setErrors, setSubmitting }) => {
      try {
        dispatch(register({ email: values.email, password: values.password, firstName: values.firstName, lastName: values.lastName, phone: values.phone, role: values.role }, enqueueSnackbar));
